...
async def match(user, msg):
    ...
    while repeat:
        try:
            ...
            try:
                print(server_data[server_id]["user_coins"][user_id])
                print(int(response_content))
                print(int(response_content) < 500 or int(response_content) > server_data[server_id]["user_coins"][user_id])
